...
[rdf:ID](http://www.w3.org/1999/02/22-rdf-syntax-ns#ID) | valzarpanotakana
...
`Profile` | `string` | 
`Table` | `string` | 
`NumberInSource` | `string` | 
`FormFromProto` | `string` | 
